...
res = utils.train_and_report_roc_and_feature_select(
    "Multi Layer Perceptron ROC and Feature Selection",
    MLPClassifier(),
    {
        ...
        # This is already gonna take a lot of processing time, let's stick with what we know is half decent
        "reduce_dim": [PCA()],
